...
** Build Directory and .gitignore
   The build process generates a build folder containing docs and code
   directories. This build folder is not version controlled since it
   is generated. To allow git to ignore generated files.
...
** Index.org 
   ...
   Filename with link :: [[https://github.com/vlead/choppella-research-pages/blob/master/index.org][index]]
   Instructions ::
   1. Include all pages in the index.org using the following command
